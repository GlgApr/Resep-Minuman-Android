...
public class CustomListAdapterMinum2 extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<Minum2> movieItems;

    public CustomListAdapterMinum2(Activity activity, List<Minum2> movieItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Minum2 m = movieItems.get(position);
